      ...
      <div className="contact__container">
        ...
        <div className="contact__card">
          ...
          >
            ...
            <button
              className={`contact__copy-btn${copied.email ? " contact__copy-btn--copied" : ""
                }`}
              onClick={(e) =>
                handleCopy(e, "sawantsagar224@gmail.com", "email")
              }
          ...
          <div className="contact__row contact__row--static">
            <div className="contact__icon-wrap">
              <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.75" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 13a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.18 2h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0 1 21 16.92z" />
              </svg>
            </div>
            ...
            <button
              className={`contact__copy-btn${copied.phone ? " contact__copy-btn--copied" : ""
                }`}
              onClick={(e) => handleCopy(e, "+91 9403927422", "phone")}
